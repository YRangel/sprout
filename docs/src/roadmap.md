...
| **v0.4** | musl/Alpine guests: supervisor-first route (kind=3 musl-dynamic), musl-specific sanitizer table, SONAME-shadow libc, absolute-symlink chasing, suid-drop swallow | **done** (busybox/applet-chains/python3/subprocess verified) |
